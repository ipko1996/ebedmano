...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "libs/kitchenware/src/lib/prisma/client",
    "kitchenware/src/lib/prisma/client",
  ]
...
path.join(process.cwd(), "libs/kitchenware/src/lib/prisma/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "libs/kitchenware/src/lib/prisma/client/schema.prisma")
